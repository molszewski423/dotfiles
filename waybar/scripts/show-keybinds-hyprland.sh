#!/usr/bin/env bash
# show-keybinds-hyprland.sh — Hyprland keybindings reference
...
show_binds() {
    ...
    header "Screenshots"
    row "Super + S"                "Screenshot → ~/Pictures + clipboard"
    row "Super + Shift + S"        "Window screenshot → ~/Pictures + clipboard"
